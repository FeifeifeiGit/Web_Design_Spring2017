                ...
                <div id="photowall" class="tab-pane fade in active" role="tabpanel">
                    ...
                    <div class="row grid">
                        ...
                        <div class='thumbnail'>
                            ...
                            <a href="controller/photo-action.php?removeLike=<?php echo $id; ?>" class="btn btn-default"><span class="glyphicon glyphicon-heart userlike"></span></a>

                            <?php }

                            //if user does not add post to like, then display add-to-like button
                            else{ ?>
                            <a href="controller/photo-action.php?addToLike=<?php echo $id; ?>" class="btn btn-default"><span class="glyphicon glyphicon-heart-empty"></span></a>
                            <?php } ?>
                            ...
                            ?>
                                    <div class='col-md-4 col-sm-6 col-lg-3 item'>
                                        ...
                                        <div class='thumbnail'>
                                             ...
                                             <div class="over">
                                              <a href="controller/photo-action.php?removeLikeTab=<?php echo $id; ?>" class="btn btn-default" id="<?php echo $id; ?>"><span class="glyphicon glyphicon-heart userlike"></span></a>
