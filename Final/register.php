        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <form method="post" role="form" action="register-action.php" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <input type="text" name="displayName" class="form-control input-lg" placeholder="Display Name" required>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group"> 
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <input class="form-control input-lg" type="date" name="birthday" placeholder="Birthday yyyy-mm-dd">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
